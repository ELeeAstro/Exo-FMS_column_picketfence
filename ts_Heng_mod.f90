...
module ts_Heng_mod
  ...
  public :: ts_Heng
  private :: lw_Heng, sw_adding, linear_log_interp, bezier_interp

contains

  subroutine ts_Heng(Bezier, nlay, nlev, Tl, pl, pe, tau_Ve, tau_IRe, tau_IRl, &
    ...
    do b = 1, 2
      ...
      call lw_Heng(nlay, nlev, be_b, bl_b, be_int_b, tau_IRe(:,b), tau_IRl(:,b), lw_up_b(:,b), lw_down_b(:,b))
  ...
  subroutine lw_Heng(nlay, nlev, be, bl, be_int, tau_IRe, tau_IRl, lw_up, lw_down)
    implicit none

...
contains
  ...
  subroutine ts_short_char_Bezier(Bezier, nlay, nlev, Tl, pl, pe, tau_Ve, tau_IRe, mu_z, F0, Tint, AB, Beta_V, Beta_IR, &
    ...
    do b = 1, 2
      ...
      call lw_grey_updown_bezier(nlay, nlev, be_b, be_int_b, tau_IRe(b,:),  lw_up_b(b,:), lw_down_b(b,:))

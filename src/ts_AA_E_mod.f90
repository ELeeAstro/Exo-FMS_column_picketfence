...
contains
  ...
  subroutine ts_AA_E(Bezier, nlay, nlev, Tl, pl, pe, tau_Ve, tau_IRe, mu_z, F0, Tint, AB, Beta_V, Beta_IR, &
    ...
    do b = 1, 2
      ...
      call lw_AA_E(nlay, nlev, be_b, be_int_b, tau_IRe(:,b), lw_a(:,b), lw_g(:,b), lw_a_surf, &
  ...
  subroutine lw_AA_E(nlay, nlev, be, be_int, tau_IRe, ww, gg, lw_a_surf, lw_up, lw_down)
    implicit none
